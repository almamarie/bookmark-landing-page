...
import IllustrationSvg from "../../resources/images/illustration-hero.svg";


const Header = (props) => {
  const openMobileNavHandler = () => {
    props.setMobileNavState(true);
  };
  return (
    <section className={styles.section}>
      ...
      <div className={styles.wrapper}>
        <header className={styles.header}>
          ...
          <nav className={styles["destop-nav"]}>
            <a href="#features" alt="features">
              FEATURES
            </a>
            <a href="#pricing" alt="pricing">
              PRICING
            </a>
        ...
        <div className={styles.hero}>
          <div className={styles.text}>
            ...
            <div className={styles.buttons}>
              ...
              <button type="text" className={styles["btn--firefox"]}>
                Get it on Firefox
              </button>
            </div>
          </div>
