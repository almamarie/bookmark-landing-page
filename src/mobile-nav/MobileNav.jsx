    ...
    <div className={styles.box}>
      <div className={styles.wrapper}>
            ...
            <g fill="none" fillRule="evenodd">
              ...
              <g>
                ...
                <path
                  ...
                  fill="#FFF"
                  className={styles["logo-circle__content"]}
                />
              </g>
            </g>
          </svg>
        ...
        <nav className={styles["nav"]}>
          <hr />
          <a onClick={closeMobileNavHandler} href="#features" alt="features">
            FEATURES
          </a>
          <hr />

          <a onClick={closeMobileNavHandler} href="#pricing" alt="pricing">
            PRICING
          </a>
          <hr />

          <a onClick={closeMobileNavHandler} href="#contact" alt="contact">
            CONTACT
          </a>
          <hr />
        </nav>
